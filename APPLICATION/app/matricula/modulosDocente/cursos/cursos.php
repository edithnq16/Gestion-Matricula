...
<body>
    ...
    <div class="d-flex">
        ...
        <div style="width: 100%;">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h7 class="card-title">Primero "A"</h7>
                                    <br>
                                    <a href="formulario.php" class="btn btn-primary">Ver contenido</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <br>
                                    <h5 class="card-title">Matematicas</h5>
                                    <h7 class="card-title">Primero "B"</h7>
                                    <br>
                                    <a href="formulario.php" class="btn btn-primary">Ver contenido</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <br>
                                    <h5 class="card-title">Matematicas</h5>
                                    <h7 class="card-title">Segundo "A"</h7>
                                    <br>
                                    <a href="formulario.php" class="btn btn-primary">Ver contenido</a>
                                </div>
                            </div>
            ...
            <!-- JavaScrip de barra lateral jQuery first, then Popper.js, then Bootstrap JS -->
