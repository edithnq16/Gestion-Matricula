        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-md-6 p-3">
            <button class="btn btn-info btn-lg btn-block" style="width: 100%; height:200px;" onclick="window.location.href='../pagos/pagos.php'">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">
          ...
          <div class="col-md-6 p-3">
            <button class="btn btn-info btn-lg btn-block" style="width: 100%; height:200px;" onclick="window.location.href='../alumnos/alumnos.php'">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
