  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="nuevoModalLabel">Nueva sección</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="../seccion/insertarSeccion.php" method="post">
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="alumnosMax" class="form-label">Cantidad Alumnos:</label>
            <input type="number" name="alumnosMax" id="alumnosMax" class="form-control" required>
          </div>
